    ...
    <>
      <div className="flex flex-col justify-center items-center flex-nowrap w-full h-screen  ">
        ...
        <div className=" flex justify-between items-center w-full py-4 px-10 shadow-lg ">
          ...
          <div>
            <Link to={'/signin'} className="bg-[#F44322] text-white px-3 py-2 rounded-md font-semibold hover:bg-orange-500">Login Account</Link>
          </div>
        </div>
            ...
            <div className="flex flex-col justify-center py-6 px-8 md:px-10  w-[360px] md:w-96 space-y-4 md:order-1 order-2 border-2 rounded-md ">
              ...
              <div className="flex flex-col gap-2">
                ...
                <input
                  id="name"
                  type="text"
                  className="border rounded-md py-1 px-2" placeholder="Enter Your Name" name="name" value={credentials.name} onChange={onChange}
                />
              </div>
              <div className="flex flex-col gap-2">
              ...
              <div className="flex flex-col gap-2">
                ...
                <input
                  ...
                  type="text"
                  className="border rounded-md py-1 px-2"
                  name="geolocation" placeholder="Enter Your Address" value={credentials.geolocation} onChange={onChange}
                />
              </div>
