                    ...
                    <>
                        <div className='flex flex-col justify-center items-center'>
                            <div className='flex flex-col justify-center items-center bg-gray-100 w-full py-16'>
                                ...
                                <span className='capitalize text-5xl font-bold tracking-wide my-2'>How does it work?</span>
                                <div className='grid grid-cols-3 justify-center items-center  w-full px-20 py-4'>
                                    <div className='flex flex-col flex-nowrap justify-center items-center gap-1'>
                                        <img src="1.png" className='w-56' alt="img" />
                                    ...
                                    <div className='flex flex-col flex-nowrap justify-center items-center'>
                                        <img src="2.png" className='w-56' alt="" />
                                        <h1 className='text-2xl font-semibold'>Get it delivered</h1>
                                        <span className='text-sm text-gray-500'>Get your meals delivered as fast as possible</span>
                                    </div>
                                    <div className='flex flex-col flex-nowrap justify-center items-center'>
                                        <img src="3.png" className='w-56' alt="" />
                            ...
                            <div className="grid grid-cols-2 justify-center items-center bg-amber-50 py-16 w-full">
                                {/* Image Section */}
                                ...
                                <div className="flex flex-col flex-nowrap justify-center items-start">
                                    <div className="flex flex-col justify-center items-start">
                                        ...
                                        <span className="capitalize text-5xl font-bold tracking-wide my-2">What they say?</span>
                                    </div>

                                    <div className="py-10 flex flex-col justify-center items-start">
                                        {/* Reviewer Info */}
                                        <div className="flex justify-center items-center gap-4">
                                            <img src={image} className="w-20 h-20 object-cover rounded-full border-4 border-yellow-500" alt={name} />
                                        ...
                                        <div className="py-6">
                                            <div
                                                className="w-4/5 h-24 overflow-hidden transition-all duration-300"
                                                style={{ maxHeight: "6rem" }}
                                            >
                                                <p className="px-4 text-xl font-semibold tracking-wide">{review}</p>
                                            </div>
                                        </div>
                                    </div>
